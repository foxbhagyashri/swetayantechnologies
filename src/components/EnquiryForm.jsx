...
/* ---------------------------------------------------------
   Swetayan Technologies — Enquiry Page
   Same design tokens as Contact Us. Difference: the form does
   NOT post anywhere — it builds the enquiry text and hands it
   off to WhatsApp (wa.me) or the user's email client (mailto:).
--------------------------------------------------------- */
...
export default function EnquiryPage() {
    return (
        <div className="font-body bg-white min-h-screen">
            ...
            <Breadcrumb
                title="Enquiry"
                subtitle="Tell us about your device and we'll get back to you over WhatsApp or Email."
                trail={[
                    { label: "Home", href: "#" },
