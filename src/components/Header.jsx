        ...
        <>
            ...
            >
                <div className="max-w-7xl mx-auto px-5 py-4 flex items-center justify-between">
                        ...
                        {links.map((link) => (
                            ...
                            link.dropdown ? (
                                ...
                                <div key={link.name} className="relative group">
                                    ...
                                    <div className="absolute left-0 top-full mt-2 w-60 bg-white rounded-lg shadow-xl border opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                    ...
                    <NavLink
                        to="/contact"
                        className="hidden lg:flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-5 py-3 rounded-md transition"
                    >
                        Get Free Diagnosis
                        <ArrowRight size={18} />
                    </NavLink>
