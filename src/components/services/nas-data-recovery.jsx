...
function SystemsSupported() {
    const items = [
        { img: "https://images.unsplash.com/photo-1558494949-ef010cbdcc31?w=500&q=70&auto=format&fit=crop", label: "Synology NAS" },
        { img: "https://images.unsplash.com/photo-1591370874773-6702e8f12fd8?w=500&q=70&auto=format&fit=crop", label: "QNAP NAS" },
        { img: "https://images.unsplash.com/photo-1591405351990-4726e331f141?w=500&q=70&auto=format&fit=crop", label: "WD My Cloud" },
        { img: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=500&q=70&auto=format&fit=crop", label: "Netgear ReadyNAS" },
        { img: "https://images.unsplash.com/photo-1496181133206-80ce9b88a853?w=500&q=70&auto=format&fit=crop", label: "RAID 0/1/5/6/10" },
        { img: "https://images.unsplash.com/photo-1573804633927-bfcbcd909acd?w=500&q=70&auto=format&fit=crop", label: "Btrfs / ext4 / ZFS" },
    ];
    return (
