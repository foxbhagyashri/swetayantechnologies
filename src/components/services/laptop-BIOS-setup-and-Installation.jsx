...
/* ---------------------------------------------------------
   Swetayan Technologies — Laptop BIOS Setup & Installation
   Service
    ...
    if (failed) {
        return (
            <div className={`${className} bg-gradient-to-br from-neutral-800 to-neutral-950 flex items-center justify-center`}>
                <Cpu className="w-10 h-10 text-neutral-600" />
            </div>
        );
    }
    ...
    return (
        <section className="relative bg-neutral-950 text-white overflow-hidden">
            <Img
                ...
                alt="Technician configuring a laptop BIOS setup screen"
            ...
            <div className="max-w-7xl mx-auto px-5 py-14 md:py-16 relative">
                <div className="flex items-center gap-2 mb-4">
                    ...
                    <span className="font-mono text-[11px] tracking-[0.2em] text-orange-400">CERTIFIED FIRMWARE & BIOS TECHNICIANS</span>
                </div>
                ...
                <div className="max-w-7xl mx-auto px-5 flex flex-col md:flex-row items-center justify-between gap-6 relative">
                    <div>
                        <h3 className="font-display font-bold text-2xl sm:text-3xl text-neutral-950 tracking-tight">
                            Stuck on a BIOS screen or boot order that won't stick?
                        </h3>
                        <p className="font-body text-neutral-900/80 mt-2">
                            Get a free BIOS diagnosis before you reinstall anything or swap hardware.
                        </p>
                    </div>
                    <a href="#contact" className="bg-neutral-950 hover:bg-neutral-800 hover:scale-105 text-white font-body font-semibold px-6 py-3 rounded-md whitespace-nowrap transition-all flex items-center gap-2">
                        Get Free BIOS Diagnosis <ArrowRight className="w-4 h-4" />
                    </a>
                </div>
            </Reveal>
        </section>
...
function Intro() {
    ...
    const stats = [
        ...
        { value: 4100, suffix: "+", label: "BIOS setups completed" },
        { value: 100, suffix: "%", label: "Settings verified post-setup" },
        { value: 45, suffix: "min", label: "Typical turnaround" },
    ];
    return (
        <section className="bg-white py-20">
            <div className="max-w-7xl mx-auto px-5 grid md:grid-cols-2 gap-14 items-center">
                <Reveal>
                    <span className="font-mono text-xs tracking-[0.2em] text-orange-600">BIOS SETUP & INSTALLATION</span>
                    <h2 className="font-display font-bold text-3xl sm:text-4xl text-neutral-900 mt-3 tracking-tight leading-tight">
                        The BIOS is the layer beneath the operating system.
                    </h2>
                    <p className="font-body text-neutral-600 mt-5 leading-relaxed">
                        Wrong boot order, a locked BIOS password, disabled virtualization,
                        or firmware that's out of date can stop a laptop from installing
                        an OS, booting from USB, running a hypervisor, or even starting up
                        at all. We configure boot mode, security, and performance settings
                        correctly, install or roll back firmware safely, and verify every
                        change against how you actually use the machine.
                    </p>
                    <div className="flex flex-wrap gap-3 mt-8">
                        <a href="/EnquiryForm" className="bg-orange-500 hover:bg-orange-400 hover:scale-105 text-neutral-950 font-body font-semibold px-6 py-3 rounded-md transition-all flex items-center gap-2">
                            Book a Free BIOS Diagnosis <ArrowRight className="w-4 h-4" />
                        </a>
                    </div>
                </Reveal>
                <Reveal delay={150}>
                    <div className="rounded-2xl overflow-hidden mb-6 border border-neutral-200">
                        <Img
                            src="/ChatGPT Image Aug 31, 2026, 12_06_17 PM.png"
                            alt="Technician entering laptop BIOS configuration screen"
...
function SymptomsGrid() {
    const items = [
        { img: "/pexels-stitch-20123833.jpg", label: "Won't Boot from USB" },
        { img: "/pexels-markusspiske-8247921.jpg", label: "Forgotten BIOS Password" },
        { img: "/pexels-thales13-37657434.jpg", label: "Wrong Boot Order" },
        { img: "/pexels-markusspiske-193350.jpg", label: "Virtualization Disabled" },
        { img: "/pexels-karola-g2-6063.jpg", label: "Stuck After Firmware Update" },
        { img: "/pexels-brett-sayles-3803517.jpg", label: "Secure Boot / TPM Errors" },
    ];
    return (
        <section className="bg-white py-14 border-y border-neutral-100">
            <div className="max-w-7xl mx-auto px-5">
                <Reveal>
                    <p className="font-mono text-xs tracking-[0.2em] text-neutral-400 text-center mb-8">SIGNS YOUR BIOS NEEDS ATTENTION</p>
                </Reveal>
    ...
    const cases = [
        {
            ...
            desc: "Setting boot mode, boot order, and startup behaviour correctly for your OS, recovery media, or dual-boot setup.",
            points: ["Boot order & priority setup", "UEFI vs Legacy mode selection", "Fast boot & startup tuning"],
        },
        {
            icon: KeyRound,
            title: "BIOS Password Reset",
            desc: "Safely clearing a forgotten supervisor or power-on BIOS password without touching your stored files.",
            points: ["Manufacturer-approved reset method", "No data drive access required", "New password set on request"],
        },
        {
            icon: Cpu,
            title: "Firmware Update & Rollback",
            desc: "Installing the correct BIOS/UEFI firmware version for your model, or rolling back a version that caused issues.",
            points: ["Model-matched firmware sourcing", "Safe update procedure", "Rollback if instability appears"],
        },
        {
            icon: TerminalSquare,
            title: "Virtualization & Dev Settings",
            desc: "Enabling virtualization, changing CPU settings, or adjusting flags needed for hypervisors and development tools.",
            points: ["VT-x / AMD-V enablement", "Hyper-V compatibility checks", "Developer-mode BIOS flags"],
        },
        {
            icon: Fingerprint,
            title: "Secure Boot & TPM Setup",
            desc: "Configuring Secure Boot and TPM correctly for OS installation, encryption tools, or compliance requirements.",
            points: ["Secure Boot enable/disable", "TPM 2.0 activation & clearing", "OS compatibility verification"],
        },
        {
            icon: HardDrive,
            title: "New Drive / OS Install Prep",
            desc: "Preparing BIOS settings so a freshly installed drive, SSD, or operating system boots correctly the first time.",
            points: ["Drive detection verification", "AHCI/RAID mode selection", "Post-install boot confirmation"],
        },
    ];
    return (
                ...
                <Reveal>
                    <div className="max-w-2xl mb-14">
                        ...
                        <h2 className="font-display font-bold text-3xl sm:text-4xl text-neutral-900 mt-3 tracking-tight">
                            Every kind of BIOS fault, one visit.
                        </h2>
                    </div>
                </Reveal>
...
//             title: "BIOS diagnosis",
//             desc: "Current firmware version, boot mode, and security settings are checked against your model's known-good configuration.",
//         },
//         {
//             img: "https://images.unsplash.com/photo-1518770660439-4636190af475?w=900&q=70&auto=format&fit=crop",
//             title: "Configuration & firmware work",
//             desc: "Settings are corrected, passwords cleared, or firmware updated using the manufacturer's supported procedure.",
//         },
//         {
//             img: "https://images.unsplash.com/photo-1573164713988-8665fc963095?w=900&q=70&auto=format&fit=crop",
//             title: "Boot verification",
//             desc: "The laptop is powered through a full boot cycle to confirm the OS, drive, and any required tools load correctly.",
//         },
//     ];
//     return (
...
function Process() {
    const steps = [
        { icon: ScanSearch, title: "Free BIOS Diagnosis", desc: "We check your current firmware version, boot mode, and settings against what your model needs." },
        { icon: FileCheck2, title: "Honest Quote", desc: "You get a clear price for the configuration, password reset, or firmware work before anything is changed." },
        { icon: Wrench, title: "Configure or Update", desc: "Settings are corrected, passwords cleared, or firmware updated using the supported manufacturer procedure." },
        { icon: Zap, title: "Full Boot Test", desc: "The laptop is cycled through a complete boot to confirm the OS, drive, and required tools all load correctly." },
        { icon: PackageCheck, title: "Ready to Collect", desc: "Your laptop is returned booting reliably, with settings documented for future reference." },
    ];
    return (
        <section className="bg-white py-20">
            <div className="max-w-7xl mx-auto px-5">
...
function DoDont() {
    const donts = [
        "Change random BIOS settings while troubleshooting, since some options depend on others being set correctly first",
        "Interrupt a firmware update once it has started, as a power loss mid-update can leave the board unusable",
        "Set a supervisor BIOS password you might forget, without noting it somewhere secure",
        "Assume a boot failure is the BIOS before checking the drive and cables are properly connected",
    ];
    const dos = [
        "Note the exact error message or screen you see when the laptop fails to boot",
        "Check whether the issue started right after a Windows update, firmware update, or hardware change",
        "Confirm your laptop's model number so the correct firmware version can be sourced",
        "Back up anything critical before firmware or drive-mode changes, as a precaution",
    ];
    return (
        <section className="bg-neutral-950 py-20">
            <div className="max-w-7xl mx-auto px-5">
...
function Guarantees() {
    const items = [
        { icon: Lock, title: "Data Left Untouched", desc: "BIOS setup and firmware work is done outside your OS drive — your files and drive contents are never altered." },
        { icon: Clock, title: "45 Min Turnaround", desc: "Most BIOS configuration, password resets, and firmware updates are completed within the visit." },
        { icon: ShieldCheck, title: "Manufacturer-Approved Methods", desc: "Firmware updates and password resets follow your laptop manufacturer's supported procedure only." },
        { icon: Zap, title: "Warranty on Service", desc: "Every BIOS setup or firmware service we provide is backed by a service warranty." },
    ];
    return (
...
function FAQ() {
    const faqs = [
        { q: "I forgot my BIOS password — can you get me back in without losing my files?", a: "Yes. BIOS password resets are done through a manufacturer-supported method that resets the firmware-level password only. Your drive, operating system, and files are never touched during this process." },
        { q: "Why won't my laptop boot from a USB drive?", a: "This is almost always a boot mode or boot order setting in the BIOS. We check whether Secure Boot, USB boot priority, or Legacy/UEFI mode is set correctly for the installer or recovery media you're using." },
        { q: "Is it safe to update the BIOS firmware myself?", a: "It can be, but a firmware update that loses power partway through can leave the motherboard unresponsive. We use the manufacturer's recommended update path and never interrupt the process once started." },
        { q: "Why do I need virtualization enabled in BIOS?", a: "Tools like Hyper-V, VirtualBox, WSL2, and some development or emulation software require VT-x (Intel) or AMD-V to be turned on in BIOS. It's disabled by default on many laptops and needs to be enabled manually." },
        { q: "Will resetting BIOS settings fix all my boot problems?", a: "Not always. A BIOS reset fixes many boot order and configuration issues, but if the underlying fault is a failing drive or damaged connector, that needs to be addressed separately, which we'll identify during the diagnosis." },
    ];
    return (
        <section className="bg-white py-20">
...
export default function LaptopBiosSetupInstallationServicePage() {
    return (
        <div className="font-body bg-white min-h-screen">
            <style>{FONT_STYLES}</style>

            <Breadcrumb
                title="Laptop BIOS Setup & Installation Service"
                subtitle="Boot order, passwords, virtualization, and firmware configured and updated correctly for your laptop."
                trail={[
                    { label: "Home", href: "/" },
                    { label: "Services", href: "/" },
                    { label: "BIOS Setup & Installation", href: "#laptop-bios-setup-service" },
                ]}
            />
            <Intro />
            <SymptomsGrid />
